...
{
    public partial class EsaarContext : DbContext
    {
        public EsaarContext()
        {
        }

        public EsaarContext(DbContextOptions<EsaarContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=localhost;Database=Esaar;Trusted_Connection=True;", x => x.UseNetTopologySuite());
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Item>(entity =>
            {
                ...
                entity.HasOne(d => d.Organization)
                    .WithMany(p => p.Items)
                    .HasForeignKey(d => d.OrganizationId)
                    .HasConstraintName("FK_Item_Organization");
